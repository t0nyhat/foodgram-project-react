    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('folower', models.ForeignKey(help_text='select user', on_delete=django.db.models.deletion.CASCADE, related_name='follower', to=settings.AUTH_USER_MODEL, verbose_name='folower')),
            ],
            options={
        ...
        migrations.AddConstraint(
            model_name='follow',
            constraint=models.UniqueConstraint(fields=('folower', 'author'), name='unique_follow_pair'),
        ),
    ]
